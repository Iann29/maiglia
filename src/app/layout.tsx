...
(function() {
  try {
    var T = {
      ...
      'default-dark': { bg: '#0a0a0a', bg2: '#111111', fg: '#f9fafb', fg2: '#9ca3af', ac: '#3b82f6', ac2: '#2563eb', cg: '#333333', nc: ['#f87171','#fb923c','#facc15','#4ade80','#22d3ee','#60a5fa','#a78bfa','#f472b6'], wc: ['#60a5fa','#4ade80','#fb923c','#a78bfa','#f472b6','#22d3ee','#facc15','#f87171'] },
