...
const INITIAL_THEMES = [
  ...
  },
  {
    ...
    colors: {
      ...
      workspaceColors: ["#0ea5e9", "#14b8a6", "#06b6d4", "#38bdf8", "#22d3ee", "#67e8f9", "#0891b2", "#0d9488"],
    },
    font: "Outfit",
    isDefault: false,
    price: 50,
  },
  {
    ...
    colors: {
      ...
      workspaceColors: ["#22c55e", "#4ade80", "#84cc16", "#16a34a", "#a3e635", "#65a30d", "#15803d", "#166534"],
    },
    font: "Nunito",
    isDefault: false,
    price: 50,
  },
  {
    ...
    colors: {
      ...
      workspaceColors: ["#f43f5e", "#f97316", "#fbbf24", "#fb7185", "#ec4899", "#fb923c", "#f472b6", "#e11d48"],
    },
    font: "Quicksand",
    isDefault: false,
    price: 75,
  },
  {
    ...
    colors: {
      ...
      workspaceColors: ["#8b5cf6", "#6366f1", "#a78bfa", "#818cf8", "#c084fc", "#a855f7", "#7c3aed", "#6d28d9"],
    },
    font: "Poppins",
    isDefault: false,
    price: 75,
